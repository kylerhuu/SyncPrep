...
export function SelectedMeetingCard({
  ...
  return (
    <div className="schedule-add-to-calendar-panel relative rounded-2xl border-2 border-slate-200 bg-white overflow-hidden shadow-lg">
      <div
        className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-slate-300 to-transparent"
        aria-hidden
      />
      <div className="border-b border-slate-200/80 bg-slate-50/50 px-5 py-4 flex items-center gap-2.5">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-1">
            <button
              type="submit"
              disabled={submitting}
              className="inline-flex items-center justify-center gap-2.5 w-full sm:w-auto min-w-[200px] min-h-[44px] rounded-xl bg-[#ff7a18] px-5 py-2.5 text-sm font-bold text-white hover:bg-[#e66d0f] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ff7a18]/50 focus-visible:ring-offset-2 transition-all duration-300 disabled:opacity-60"
            >
              <CalendarIcon />
